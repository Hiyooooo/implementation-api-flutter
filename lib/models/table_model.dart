...
class TableModel {
  List<TableStanding> table;

  TableModel({required this.table});

  factory TableModel.fromJson(Map<String, dynamic> json) => TableModel(
    table: List<TableStanding>.from(
      json["table"].map((x) => TableStanding.fromJson(x)),
    ),
  );
...
class TableStanding {
  ...
  factory TableStanding.fromJson(Map<String, dynamic> json) => TableStanding(
